...
export default function HeroSection() {
  return (
    <>
      <div className="bg-white text-black px-4 md:px-10 py-6">
        <div className="flex flex-col md:flex-row justify-between mx-2 md:mx-9 rounded-lg bg-gray-50 p-4 md:p-8">
          ...
          <Image
            width={400}
            height={10}
            className="object-cover w-full md:w-[27rem] h-[10rem] rounded-t-lg md:rounded-none md:rounded-s-lg p-2 pr-4 rounded-xl"
        ...
        <div className="flex flex-col py-8 px-4 md:px-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-12 py-1">
          ...
          <div className="flex flex-col pt-10 bg-white text-black">
            <div className="flex flex-wrap gap-2 text-black rounded-full">
              <button
                type="button"
